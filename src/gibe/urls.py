...
urlpatterns = patterns('',
    ...
    (r'^admin/posts$', 'gibe.gibeapp.views.admin.posts'),
    (r'^admin/drafts/(?P<id>[^/]*)$', 'gibe.gibeapp.views.admin.editor'),
    (r'^admin/editor/!preview', 'gibe.gibeapp.views.admin.preview'),
